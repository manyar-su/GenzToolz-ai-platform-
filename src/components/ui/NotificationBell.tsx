...
export default function NotificationBell() {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && (
        <div className="absolute right-0 top-12 z-50 w-80 rounded-2xl border border-gray-200 bg-white shadow-xl dark:border-gray-700 dark:bg-gray-800">
            ...
            {notifications.length === 0 ? (
              ...
              notifications.map(n => (
                ...
                >
                  ...
                  <button onClick={e => { e.stopPropagation(); remove(n.id) }} className="text-gray-300 hover:text-gray-500 dark:hover:text-gray-300">
