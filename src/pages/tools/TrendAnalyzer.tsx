      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="grid gap-8 md:grid-cols-2">
          ...
          <div className="rounded-xl bg-white p-6 shadow-sm ring-1 ring-gray-100">
            <h1 className="mb-2 text-2xl font-bold text-gray-900">Trend Analyzer</h1>
          ...
          <div className="space-y-6">
            <h2 className="text-lg font-bold text-gray-900">Hasil Analisa Tren</h2>
            
            {results.length > 0 ? (
              results.map((item, index) => (
                <div key={index} className="rounded-xl bg-white p-6 shadow-sm ring-1 ring-gray-100">
                  <div className="mb-4 flex items-center justify-between border-b border-gray-100 pb-3">
                    <h3 className="font-semibold text-gray-800">{item.title || `Tren #${index + 1}`}</h3>
              ...
              <div className="rounded-xl bg-white p-12 text-center shadow-sm ring-1 ring-gray-100">
                ...
                <h3 className="mb-2 font-medium text-gray-900">Belum ada analisa</h3>
